                    ...
                    <table>
                        ...
                        <?php foreach($leaveRequests as $key =>$leave): ?>
                            ...
                            <?php if( $leave['approve'] == 1):  ?>
                                ...
                                <?php if( $leave['issue'] == 1): ?>
                                   <td><a href="issue.php?id=<?php echo $leave['id'] ?>" class="edit">Approved</a></td>

                                <?php elseif($leave['issue'] == 0):?>
                                    <td><a href="issue.php?id=<?php echo $leave['id'] ?>" class="edit">Pending</a></td>
