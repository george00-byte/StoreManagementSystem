    ...
    <div class="admin-wrapper">
        ...
        <div class="admin-content">
            ...
            <div class="content">
                ...
                <form  action="createDepartment.php" method=post enctype="multipart/form-data" >
                    ...
                    <!-- // Display of errors -->
                     ...
                     <div>
                        ...
                        <input type="text" name="department" id="name"  class="text-input" value="<?php echo $item; ?>" />
                    </div>
                    ...
                    <div>
                        <button name="create-department" class="btn btn-big">Create Department</button>
