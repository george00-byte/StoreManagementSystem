                    ...
                    <table>
                        ...
                        <?php foreach($items as $key =>$item): ?>
                            <tr>
                                ...
                                <td><a href="subtract.php?id=<?php echo $item['id'] ?>"   class="edit">Subtact</a></td>
                                <td><a href="subtract.php?remaining_id=<?php echo $item['id'] ?>" class="delete" onclick="return checkDelete()">delete</a></td>
