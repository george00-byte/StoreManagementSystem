        ...
        <div class="admin-content">
            ...
            <div class="content">
                ...
                <form  action="alert.php" method=post enctype="multipart/form-data" >
                    ...
                    <input type="hidden" name="alert" id="name"  class="text-input" value="<?php echo $alert; ?>" />
                    ...
                    <div>
                        <label>Minimum Value for  Alert</label>
                        <input type="text" name="alert" id="name" min="1" max="100"  class="text-input" />
                    </div>
                    ...
                    <div>
                        <button name="add_alert" class="btn btn-big">Add Alert</button>
